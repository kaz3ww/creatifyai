  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 px-4 bg-slate-50">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-4">
            {[
              { q: "How do I create an AI fashion influencer?", a: "Describe the fashion model's physical traits, outfit, and setting in the Creatify AI generator. The AI will instantly produce a photorealistic image matching your fashion concept." },
              { q: "Can I use AI fashion models for my clothing brand?", a: "Yes, you can use generated AI fashion influencers for e-commerce, lookbooks, social media campaigns, and product modeling without needing a physical photoshoot." },
              { q: "Can I maintain the same fashion model across different outfits?", a: "Yes. By using the same character prompt and utilizing our face consistency features, you can generate the exact same AI fashion influencer wearing entirely different clothing in new settings." }
            ].map((faq) => (
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        mainEntity: [
          { "@type": "Question", name: "How do I create an AI fashion influencer?", acceptedAnswer: { "@type": "Answer", text: "Describe the fashion model's physical traits, outfit, and setting in the Creatify AI generator. The AI will instantly produce a photorealistic image matching your fashion concept." } },
          { "@type": "Question", name: "Can I use AI fashion models for my clothing brand?", acceptedAnswer: { "@type": "Answer", text: "Yes, you can use generated AI fashion influencers for e-commerce, lookbooks, social media campaigns, and product modeling without needing a physical photoshoot." } },
          { "@type": "Question", name: "Can I maintain the same fashion model across different outfits?", acceptedAnswer: { "@type": "Answer", text: "Yes. By using the same character prompt and utilizing our face consistency features, you can generate the exact same AI fashion influencer wearing entirely different clothing in new settings." } }
        ]
      }) }} />
