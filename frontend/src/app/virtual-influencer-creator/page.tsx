...
const faqs = [
  ...
  { q: "How do I create a virtual influencer with Creatify AI?", a: "Describe your virtual influencer through text prompts — appearance, personality, niche, and style. Creatify AI generates photorealistic images and videos of your digital persona in seconds." },
  ...
  { q: "Are virtual influencers legal to use commercially?", a: "Yes. As long as the AI-generated content doesn't fraudulently impersonate real people, virtual influencers are legal business assets. Creatify AI's platform generates fully original characters." },
      ...
      <section className="bg-gradient-to-br from-rose-900 via-slate-900 to-[#1736cf]/70 text-white py-24 px-4">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-slate-400 max-w-3xl mx-auto mb-10 text-lg leading-relaxed">
            Virtual influencers are the future of digital marketing. Create yours with Creatify AI — a photorealistic AI persona with a consistent identity, unlimited content, and zero management overhead. Build a digital brand that earns without a real person behind it.
          </p>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            {[
              ...
              { title:"Agency at Scale", desc:"A content agency creates 10 virtual influencers for 10 different brand niches, managing all content production through Creatify AI — serving multiple clients at once without hiring more photographers or models." },
            ].map((e) => (
